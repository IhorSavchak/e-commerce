...
`pl.ihorsavchak.ecommerce.playground.SqlTest` 
...
* [src/test/java/pl/jkanclerz/ecommerce/playground/SqlTest.java](../src/test/java/pl/ihorsavchak/ecommerce/playground/SqlTest.java)
